    ...
    <div x-data="{ menuOpen: false, scrolled: false }" @scroll.window="scrolled = window.scrollY > 16" @keydown.escape.window="menuOpen = false"
        ...
        <main class="flex-1 relative px-5 md:px-8 pt-24 md:pt-28 pb-20 overflow-hidden">
            <div class="max-w-5xl mx-auto">
                <h1 class="text-3xl md:text-4xl font-display text-(--ink) mb-10">Privacy Policy</h1>
                <article class="prose max-w-full">
                    <p><strong>Last updated: 02-09-2026</strong></p>

                    <p>
                        Sri Gurukulam Kalari operates
                        <strong>srigurukulamkalari.com</strong>. This page informs you of our
                    ...
                    <p>
                        ...
                        your name, phone number, email ID, age, city and gender.
                    </p>
                    ...
                    <p>
                        This Privacy Policy is effective as of 2nd Sept 2026 and will remain in
                    ...
                    <p>
                        ...
                        your consent to abide by and be bound by the modified Privacy Policy.
                    </p>
                </article>
            </div>
        </main>
